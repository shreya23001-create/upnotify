...
7. **Anchor-text mix:** 20% exact match / 50% partial match / 30% generic (e.g. "learn more", "read the guide").` : ''
  ...
  return `You are writing a blog post for Uptrue (upnotify-monitoring.vercel.app) — a website monitoring suite covering uptime, SSL, DNS, security headers, WordPress health, and more.
