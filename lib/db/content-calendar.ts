/**
 * DB layer for the content_calendar table — the 168-page plan
 * driving the May 2026 content push.
 *
 * Single owner of this table. Pages must NOT use raw supabase calls
 * for content_calendar — go through this module.
 */
