...
const CARDS: FeatureCard[] = [
  ...
  },
  {
    ...
    desc: 'Two-confirmation detection: when a check fails, Upnotify waits 30 seconds and verifies from a second region before triggering any alert.',
  ...
  {
    cat: 'Reporting', catColor: '#2ee06b', catBg: 'rgba(46,224,107,0.1)', catBorder: 'rgba(46,224,107,0.2)',
    glow: 'linear-gradient(90deg,#2ee06b,#3b82f6)',
    iconBg: 'linear-gradient(135deg,rgba(46,224,107,0.15),rgba(59,130,246,0.1))',
    icon: (<LayoutDashboard size={22} strokeWidth={1.8} color="#2ee06b" />), title: 'Public Status Pages',
  ...
  },
  {
    ...
    glow: 'linear-gradient(90deg,#ec4899,#2ee06b)',
    iconBg: 'linear-gradient(135deg,rgba(236,72,153,0.12),rgba(46,224,107,0.12))',
  ...
  // Compete card hidden — launching in v1.5
  {
    ...
    icon: (<Zap size={22} strokeWidth={1.8} color="#10b981" />), title: 'Upnotify Score',
  ...
  },
  {
    ...
    glow: 'linear-gradient(90deg,#3b82f6,#2ee06b)',
    iconBg: 'linear-gradient(135deg,rgba(59,130,246,0.12),rgba(46,224,107,0.1))',
  ...
  {
    cat: 'Intelligence', catColor: '#2ee06b', catBg: 'rgba(46,224,107,0.1)', catBorder: 'rgba(46,224,107,0.2)',
    glow: 'linear-gradient(90deg,#2ee06b,#06b6d4)',
    iconBg: 'linear-gradient(135deg,rgba(46,224,107,0.15),rgba(6,182,212,0.12))',
    icon: (<Sparkles size={22} strokeWidth={1.8} color="#2ee06b" />), title: 'AI Visibility',
