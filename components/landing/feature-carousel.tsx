...
const CARDS: FeatureCard[] = [
  ...
  {
    cat: 'Reporting', catColor: '#0068DB', catBg: 'rgba(0, 104, 219,0.1)', catBorder: 'rgba(0, 104, 219,0.2)',
    glow: 'linear-gradient(90deg,#0068DB,#3b82f6)',
    iconBg: 'linear-gradient(135deg,rgba(0, 104, 219,0.15),rgba(59,130,246,0.1))',
    icon: (<LayoutDashboard size={22} strokeWidth={1.8} color="#0068DB" />), title: 'Public Status Pages',
  ...
  },
  {
    ...
    glow: 'linear-gradient(90deg,#3b82f6,#0068DB)',
    iconBg: 'linear-gradient(135deg,rgba(59,130,246,0.12),rgba(0, 104, 219,0.1))',
  ...
  {
    cat: 'Intelligence', catColor: '#0068DB', catBg: 'rgba(0, 104, 219,0.1)', catBorder: 'rgba(0, 104, 219,0.2)',
    glow: 'linear-gradient(90deg,#0068DB,#06b6d4)',
    iconBg: 'linear-gradient(135deg,rgba(0, 104, 219,0.15),rgba(6,182,212,0.12))',
    icon: (<Sparkles size={22} strokeWidth={1.8} color="#0068DB" />), title: 'AI Visibility',
