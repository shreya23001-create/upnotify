              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 10 }}>
                <button
                  ...
                  style={{
                    ...
                    background: domainFilter === null ? '#667eea' : 'transparent',
                    color: domainFilter === null ? '#fff' : 'var(--text-secondary)',
                    borderColor: domainFilter === null ? '#667eea' : 'var(--border-input)',
                ...
                {domains.map(d => (
                  <button
                    ...
                    style={{
                      padding: '4px 12px', borderRadius: 20, fontSize: 12, fontWeight: 600, cursor: 'pointer', border: '1.5px solid',
                      background: domainFilter === d ? '#667eea' : 'transparent',
                      color: domainFilter === d ? '#fff' : 'var(--text-secondary)',
                      borderColor: domainFilter === d ? '#667eea' : 'var(--border-input)',
                      transition: 'all 0.15s',
                    }}
                  >
                    {d}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              <button
                ...
                style={{
                  ...
                  color: '#667eea', padding: 0, textDecoration: 'underline',
                }}
              >
