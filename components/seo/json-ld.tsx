...
export function SoftwareApplicationJsonLd(): React.ReactElement {
  const data = {
    ...
    url: 'https://upnotify-monitoring.vercel.app',
    description:
      'Uptime, performance and infrastructure monitoring for agencies and teams. 24 monitor types, instant health reports, public status pages, multi-channel alerts, free SSL checker and uptime calculator, and a public uptime leaderboard.',
    featureList: [
      '24 monitor types (HTTP, SSL, DNS, API, keyword, TCP, and more)',
      '1-minute check intervals',
      'Two-region confirmation to eliminate false alarms',
      'Instant deterministic uptime reports',
