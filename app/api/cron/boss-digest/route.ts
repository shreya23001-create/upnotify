// =============================================================================
// Cron: boss-digest
// Schedule: Daily at 07:00 UTC (configured in vercel.json — to be added)
// Purpose: Build and send the Boss Digest email — single email batching
//          all blog_posts where delivery_method='digest', digest_status='pending'.
//          Marks sent posts as in_digest. Audit row in boss_digest_runs.
//
// Pairs with calendar/draft-runner (every hour) which produces the drafts
// this cron batches.
// =============================================================================
