  ...
  return (
    <div className="help-layout">
      ...
      <article className="help-content">
        <h1 className="help-title">Cancel or Pause Your Subscription</h1>
        <p className="help-intro">You can cancel or pause your subscription at any time from your billing settings. We offer a pause option so you can take a break without losing your setup.</p>

        <section className="help-section">
          <h2>How to Cancel or Pause</h2>
          <ol>
        ...
        <section className="help-section">
          <h2>Re-subscribing After Cancellation</h2>
