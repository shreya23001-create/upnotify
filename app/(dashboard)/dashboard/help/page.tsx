    ...
    <div className="help-layout">
      ...
      <div className="help-main">
        ...
        <div className="help-hero">
          <div className="help-hero-accent" />
          <div className="help-hero-body">
            <div className="help-hero-icon">
              <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>
            </div>
            <div>
        ...
        {filtered.length > 0 && (
          <div className="help-topics-grid">
            {filtered.map((topic) => (
              <Link key={topic.href} href={topic.href} className="help-topic-card">
            ...
            <Link href="/dashboard/support" className="help-topic-card help-topic-card-support">
              <div className="help-topic-icon-wrap">
