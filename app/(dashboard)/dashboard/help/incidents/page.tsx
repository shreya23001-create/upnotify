  ...
  return (
    <div className="help-layout">
      ...
      <article className="help-content">
        <h1 className="help-title">Incidents</h1>
        <p className="help-intro">Incidents are created automatically when a monitor confirms downtime. They track the lifecycle of an outage from detection to resolution.</p>

        <section className="help-section">
          <h2>How Incidents Work</h2>
