    ...
    <div>
      ...
      {org && (
        <>
          ...
          {competeSub && cp && (
              <div className="card" style={{ padding: 20, marginBottom: 16, borderLeft: '3px solid #0068DB' }}>
                <h3 style={{ fontSize: 13, fontWeight: 700, marginBottom: 16, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#0068DB' }}>
                  Compete Plan
                </h3>

                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 12, marginBottom: 16 }}>
                  {[
                    { label: 'Plan', value: cp.name, sub: competeSub.billing_cycle, color: '#0068DB' },
                    {
                ...
                <div style={{ marginTop: 8 }}>
                  ...
                  <div style={{ height: 8, background: 'var(--border-primary)', borderRadius: 4 }}>
                    <div style={{
                      ...
                      background: productUsagePct > 80 ? '#ef4444' : productUsagePct > 50 ? '#f59e0b' : '#0068DB',
                      borderRadius: 4,
