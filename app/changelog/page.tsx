...
const ENTRIES = [
  {
    ...
    items: [
      ...
      { type: 'new',      text: 'Outage blog engine — AI-generated outage reports auto-published with human approval gate' },
      ...
      { type: 'new',      text: 'Support system — ticket management with Customer 360 quick-link and AI draft replies' },
      ...
      { type: 'improved', text: 'Consistent nav-to-content spacing standardised across all public pages' },
      { type: 'improved', text: 'Homepage horizontal scroll eliminated on all screen sizes' },
      { type: 'fixed',    text: 'Trusted logos visibility corrected for both light and dark themes' },
    ],
  },
  {
    date: 'March 2026',
    ...
    items: [
      ...
      { type: 'new', text: 'Alert channels — email, Slack, Microsoft Teams, Telegram, and signed webhooks' },
